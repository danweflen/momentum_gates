...
grid=np.arange(-10,10.01,0.01)
arg=np.fmax(np.exp(-(grid)**2),np.zeros(grid.size))
x=np.arange(-10,10.01,0.01).reshape((1,grid.size))
p=np.arange(-10,10.01,0.01).reshape((grid.size,1))
ana=np.sqrt(1/(2*pi))*np.exp(-2*x**2)*np.exp(-pi**2*p**2/2.0)
